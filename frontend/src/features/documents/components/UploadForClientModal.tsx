...
import { Upload, Calendar as CalendarIcon, ChevronDown, ChevronRight, Save, X, FileText, Loader2 } from 'lucide-react';
...
interface UploadForClientModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSubmit: (
        ...
        flow?: typeof DocumentFlowEnum.UPLOAD
...
export function UploadForClientModal({
    isOpen,
    onClose,
    onSubmit,
    onUploadFile,
    ...
    const handleSaveAsDraft = async () => {
        ...
        try {
            const documentId = await onSubmit(
                ...
                data.dueDate,
                'DRAFT',
                DocumentFlowEnum.UPLOAD
            );

            // If a file was selected and we got a document ID, upload the file
            if (file && onUploadFile && documentId) {
            ...
            <DialogContent className="sm:max-w-2xl">
                <DialogHeader>
                    <div className="flex items-center gap-3">
                        ...
                        <DialogTitle className="text-foreground">{t('uploadForClientModal.title')}</DialogTitle>
                    </div>
                </DialogHeader>
                ...
                <Form {...form}>
                    <div className="space-y-6 py-4">
                        ...
                        <div className="space-y-2">
                            <FormLabel>{t('uploadForClientModal.selectFile', 'Document File')}</FormLabel>
                            {!file ? (
                                <div
                                    {...getRootProps()}
                        ...
                        <div className="p-4 rounded-lg border-2 border-border bg-muted/50">
                            <p
                                ...
                                dangerouslySetInnerHTML={{
                                    __html: DOMPurify.sanitize(t('uploadForClientModal.infoText')),
                                }}
                            />
                        </div>
                        ...
                        <DialogFooter className="gap-2 sm:gap-2">
                            ...
                            <Button
                                ...
                                disabled={!form.formState.isValid || !file || isUploading}
                                className="gap-2"
                            >
                                {isUploading ? (
                                    <>
                                    ...
                                    <>
                                        ...
                                        {t('actions.uploadAndShare', 'Upload & Share')}
                                    </>
                                )}
                            </Button>
                        </DialogFooter>
