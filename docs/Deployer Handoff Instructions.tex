...
% --- Prevent orphaned section/subsection titles at bottom of pages ---
\let\oldsection\section
\renewcommand{\section}{\clearpage\oldsection}
\let\oldsubsection\subsection
\renewcommand{\subsection}{\Needspace{6cm}\oldsubsection}
\let\oldsubsubsection\subsubsection
\renewcommand{\subsubsection}{\Needspace{5cm}\oldsubsubsection}

% --- Prevent code listings from splitting across pages at bad points ---
\BeforeBeginEnvironment{lstlisting}{\needspace{5\baselineskip}}

% --- Keep list items with their following code blocks together ---
...
\midrule
Shawn Nabizada     & 25\% & \S1, \S2, \S3.1--\S3.3 & Infrastructure setup, CI/CD pipeline, overall review \\
Amir Ghadimi       & 25\% & \S3.4--\S3.7, \S4 & Auth0 \& external services config, deployment workflow \\
Olivier Goudreault & 25\% & \S5, \S6, \S7 & Environment documentation, monitoring, restart procedures \\
Isaac Nachate      & 25\% & \S8, \S9, \S10, \S11, \S12 & Database management, CI/CD details, troubleshooting, formatting \\
\midrule
\textbf{SUM}       & \textbf{100\%} & & \\
\bottomrule
\end{tabularx}
