...
-- - Audit Tables (login, logout, password_reset, org_settings)
-- - Fixes: All business IDs are UUIDs.
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    transaction_id UUID UNIQUE,      -- Fixed: UUID
    client_id UUID,                  -- Fixed: UUID
    broker_id UUID,                  -- Fixed: UUID
...
CREATE TABLE IF NOT EXISTS document_requests (
    id BIGSERIAL PRIMARY KEY,
    request_id UUID UNIQUE,          -- Fixed: UUID
    -- Embedded TransactionRef
    transaction_id UUID,             -- Fixed: UUID
    client_id UUID,                  -- Fixed: UUID
    side VARCHAR(50),
    -- Document fields
    doc_type VARCHAR(100),
