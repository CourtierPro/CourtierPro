...
CREATE TABLE IF NOT EXISTS organization_settings (
    ...
    document_submitted_subject_en VARCHAR(255),
    document_submitted_body_en TEXT,
    document_submitted_subject_fr VARCHAR(255),
    document_submitted_body_fr TEXT,
    document_requested_subject_en VARCHAR(255),
    ...
    document_review_body_fr TEXT,
    stage_update_subject_en VARCHAR(255),
