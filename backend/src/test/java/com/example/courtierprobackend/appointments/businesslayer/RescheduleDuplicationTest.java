...
public class RescheduleDuplicationTest {
        ...
        public void testRescheduleUpdatesExistingAppointment() {
                ...
                var cancelledAppt = appointmentRepository.findByAppointmentId(appointmentId).get();
                ...
                AppointmentReviewDTO rescheduleReq = new AppointmentReviewDTO(
                                AppointmentReviewDTO.ReviewAction.RESCHEDULE, null, LocalDate.now().plusDays(2),
                                LocalTime.of(14, 0),
                                LocalTime.of(15, 0));
                ...
                // 5. Verify
                // Ensure ID is same
                Assertions.assertEquals(appointmentId, rescheduled.appointmentId(),
                                "Appointment ID should remain the same");
                ...
                // broker
                int countForBroker = appointmentRepository.findByBrokerIdOrderByFromDateTimeAsc(brokerId)
                                .size();
