...
class AppointmentServiceNotificationTest {
    ...
    void sendAppointmentReminders_shouldSendEmails_ForUpcomingAppointments() {
        ...
        verify(emailService).sendAppointmentReminderNotification(upcoming, broker.getEmail(), "John Broker", "en");
        verify(emailService).sendAppointmentReminderNotification(upcoming, client.getEmail(), "Jane Client", "en");
